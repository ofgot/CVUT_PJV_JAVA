...
public interface Queue {
    ...
    /**
     * Returns {@code true} if the queue is empty, {@code false} otherwise. If the returned value is {@code true},
    ...
    /**
     * Returns {@code true} if the queue is full, {@code false} otherwise. If the queue is full, then
     ...
     * @return {@code true} if the element is added, {@code false} otherwise.
     * @see #isFull()
     */
